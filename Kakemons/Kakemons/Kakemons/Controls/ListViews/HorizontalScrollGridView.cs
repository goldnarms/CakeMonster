...
namespace Kakemons.UI.Controls.ListViews
{
    public class HorizontalScrollGridView : Grid
    {
        /// <summary>
        /// Thanks to: https://github.com/DanielCauser/XamarinHorizontalList/blob/master/XamarinHorizontalList/XamarinHorizontalList/Controls/HVScrollGridView.cs
        ...
        public static readonly BindableProperty SelectedCommandProperty =
            BindableProperty.Create("SelectedCommand", typeof(ICommand), typeof(HorizontalScrollGridView), null);

        public static readonly BindableProperty ItemsSourceProperty =
            BindableProperty.Create("ItemsSource", typeof(IEnumerable), typeof(HorizontalScrollGridView), default(IEnumerable<object>), BindingMode.TwoWay, propertyChanged: ItemsSourceChanged);

        public static readonly BindableProperty SelectedItemProperty =
            BindableProperty.Create("SelectedItem", typeof(object), typeof(HorizontalScrollGridView), null, BindingMode.TwoWay, propertyChanged: OnSelectedItemChanged);

        public static readonly BindableProperty ItemTemplateProperty =
            BindableProperty.Create("ItemTemplate", typeof(DataTemplate), typeof(HorizontalScrollGridView), default(DataTemplate));
        ...
        {
            var itemsLayout = (HorizontalScrollGridView)bindable;
            itemsLayout.SetItems();
        }

        public HorizontalScrollGridView()
        {
        ...
        {
            var itemsView = (HorizontalScrollGridView)bindable;
