...
namespace Kakemons.UI.Controls.Entries
{
    public class FloatingEntry : ContentView, IDisposable
    {
        ...
        {
            var containerStackLayout = new StackLayout { VerticalOptions = LayoutOptions.StartAndExpand, Spacing = 2, Padding = 5 };
            ...
            var entryFrame = new Frame { BackgroundColor = (Color)Application.Current.Resources["White75"], Padding = 0, CornerRadius = 3};
            var entryLayout = new StackLayout { Padding = 6 };
        ...
        protected override void OnPropertyChanged(string propertyName = null)
        {
            ...
            {
                if (string.IsNullOrEmpty(ValidationError) || (ValidateOnFocusLost && _textEntry.IsFocused))
                    return;
                _infoLabel.Text = ValidationError?.ToUpperInvariant();
                _infoLabel.TextColor = ValidationErrorColor;
            }
            ...
            {
                _textEntry.IsPassword = IsPassword;
            }
